...
void setup_scr_ui_Oven(lv_ui *ui){
	...
	lv_obj_set_pos(ui->ui_Oven_Img_Door, 5, 0);
	...
	//Write codes ui_Oven_imgbtn_1
	ui->ui_Oven_imgbtn_1 = lv_imgbtn_create(ui->ui_Oven_Group_Oven);
	lv_obj_set_pos(ui->ui_Oven_imgbtn_1, 203, 607);
	lv_obj_set_size(ui->ui_Oven_imgbtn_1, 134, 51);
	lv_obj_set_scrollbar_mode(ui->ui_Oven_imgbtn_1, LV_SCROLLBAR_MODE_OFF);

	//Write style state: LV_STATE_DEFAULT for style_ui_oven_imgbtn_1_main_main_default
	static lv_style_t style_ui_oven_imgbtn_1_main_main_default;
	if (style_ui_oven_imgbtn_1_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_ui_oven_imgbtn_1_main_main_default);
	else
		lv_style_init(&style_ui_oven_imgbtn_1_main_main_default);
	lv_style_set_text_color(&style_ui_oven_imgbtn_1_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_text_font(&style_ui_oven_imgbtn_1_main_main_default, &lv_font_Antonio_Regular_26);
	lv_style_set_text_align(&style_ui_oven_imgbtn_1_main_main_default, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_ui_oven_imgbtn_1_main_main_default, lv_color_make(0xFF, 0x91, 0x10));
	lv_style_set_img_recolor_opa(&style_ui_oven_imgbtn_1_main_main_default, 255);
	lv_style_set_img_opa(&style_ui_oven_imgbtn_1_main_main_default, 255);
	lv_obj_add_style(ui->ui_Oven_imgbtn_1, &style_ui_oven_imgbtn_1_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style state: LV_STATE_CHECKED for style_ui_oven_imgbtn_1_main_main_checked
	static lv_style_t style_ui_oven_imgbtn_1_main_main_checked;
	if (style_ui_oven_imgbtn_1_main_main_checked.prop_cnt > 1)
		lv_style_reset(&style_ui_oven_imgbtn_1_main_main_checked);
	else
		lv_style_init(&style_ui_oven_imgbtn_1_main_main_checked);
	lv_style_set_text_color(&style_ui_oven_imgbtn_1_main_main_checked, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_text_font(&style_ui_oven_imgbtn_1_main_main_checked, &lv_font_Antonio_Regular_26);
	lv_style_set_text_align(&style_ui_oven_imgbtn_1_main_main_checked, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_ui_oven_imgbtn_1_main_main_checked, lv_color_make(0x35, 0xC9, 0x15));
	lv_style_set_img_recolor_opa(&style_ui_oven_imgbtn_1_main_main_checked, 255);
	lv_style_set_img_opa(&style_ui_oven_imgbtn_1_main_main_checked, 255);
	lv_obj_add_style(ui->ui_Oven_imgbtn_1, &style_ui_oven_imgbtn_1_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->ui_Oven_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_BTN_oven_alpha_134x51, NULL);
	lv_imgbtn_set_src(ui->ui_Oven_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_BTN_oven_alpha_134x51, NULL);
	lv_imgbtn_set_src(ui->ui_Oven_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_BTN_oven_alpha_134x51, NULL);
	lv_imgbtn_set_src(ui->ui_Oven_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_BTN_oven_alpha_134x51, NULL);
	lv_obj_add_flag(ui->ui_Oven_imgbtn_1, LV_OBJ_FLAG_CHECKABLE);
	ui->ui_Oven_imgbtn_1_label = lv_label_create(ui->ui_Oven_imgbtn_1);
	lv_label_set_text(ui->ui_Oven_imgbtn_1_label, "START");
	lv_obj_set_style_pad_all(ui->ui_Oven_imgbtn_1, 0, LV_STATE_DEFAULT);
	lv_obj_align(ui->ui_Oven_imgbtn_1_label, LV_ALIGN_CENTER, 0, 0);
