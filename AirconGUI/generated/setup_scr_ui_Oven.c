...
void setup_scr_ui_Oven(lv_ui *ui){
	...
	//Write codes ui_Oven_Cont
	ui->ui_Oven_Cont = lv_obj_create(ui->ui_Oven);
	lv_obj_set_pos(ui->ui_Oven_Cont, 677, 17);
	lv_obj_set_size(ui->ui_Oven_Cont, 534, 686);
	lv_obj_set_scrollbar_mode(ui->ui_Oven_Cont, LV_SCROLLBAR_MODE_OFF);

	//Write style state: LV_STATE_DEFAULT for style_ui_oven_cont_main_main_default
	static lv_style_t style_ui_oven_cont_main_main_default;
	if (style_ui_oven_cont_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_ui_oven_cont_main_main_default);
	else
		lv_style_init(&style_ui_oven_cont_main_main_default);
	lv_style_set_radius(&style_ui_oven_cont_main_main_default, 20);
	lv_style_set_bg_color(&style_ui_oven_cont_main_main_default, lv_color_make(0x24, 0x24, 0x24));
	lv_style_set_bg_grad_color(&style_ui_oven_cont_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_dir(&style_ui_oven_cont_main_main_default, LV_GRAD_DIR_NONE);
	lv_style_set_bg_opa(&style_ui_oven_cont_main_main_default, 250);
	lv_style_set_border_color(&style_ui_oven_cont_main_main_default, lv_color_make(0x4A, 0x4C, 0x4A));
	lv_style_set_border_width(&style_ui_oven_cont_main_main_default, 1);
	lv_style_set_border_opa(&style_ui_oven_cont_main_main_default, 255);
	lv_style_set_pad_left(&style_ui_oven_cont_main_main_default, 0);
	lv_style_set_pad_right(&style_ui_oven_cont_main_main_default, 0);
	lv_style_set_pad_top(&style_ui_oven_cont_main_main_default, 0);
	lv_style_set_pad_bottom(&style_ui_oven_cont_main_main_default, 0);
	lv_obj_add_style(ui->ui_Oven_Cont, &style_ui_oven_cont_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write codes ui_Oven_line
	ui->ui_Oven_line = lv_line_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Label_CurrTemp = lv_label_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_line_5 = lv_line_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_line_4 = lv_line_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_line_3 = lv_line_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_line_2 = lv_line_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_line_1 = lv_line_create(ui->ui_Oven_Cont);
	lv_obj_set_pos(ui->ui_Oven_line_1, 267, 401);
	lv_obj_set_size(ui->ui_Oven_line_1, 17, 177);
	...
	static lv_point_t ui_Oven_line_1[] ={{0, 0},{0, 50},};
	lv_line_set_points(ui->ui_Oven_line_1,ui_Oven_line_1,2);

	//Write codes ui_Oven_Label_Temp
	ui->ui_Oven_Label_Temp = lv_label_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Label_Cen = lv_label_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Label_Status = lv_label_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Label_CurrStat = lv_label_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Label_Time = lv_label_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Bar_Time = lv_bar_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Label_Mode = lv_label_create(ui->ui_Oven_Cont);
	...
	ui->ui_Oven_Btn_ModeLeft = lv_imgbtn_create(ui->ui_Oven_Cont);
	lv_obj_set_pos(ui->ui_Oven_Btn_ModeLeft, 32, 291);
	...
	ui->ui_Oven_Btn_ModeRigth = lv_imgbtn_create(ui->ui_Oven_Cont);
	lv_obj_set_pos(ui->ui_Oven_Btn_ModeRigth, 471, 291);
	...
	lv_obj_set_pos(ui->ui_Oven_Tile_Mode, 713, 294);
	lv_obj_set_size(ui->ui_Oven_Tile_Mode, 466, 86);
