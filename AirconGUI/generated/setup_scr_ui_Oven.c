...
void setup_scr_ui_Oven(lv_ui *ui){
	...
	//Write style state: LV_STATE_DEFAULT for style_ui_oven_img_label_bg_main_main_default
	static lv_style_t style_ui_oven_img_label_bg_main_main_default;
	if (style_ui_oven_img_label_bg_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_ui_oven_img_label_bg_main_main_default);
	else
		lv_style_init(&style_ui_oven_img_label_bg_main_main_default);
	lv_style_set_img_recolor(&style_ui_oven_img_label_bg_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_img_recolor_opa(&style_ui_oven_img_label_bg_main_main_default, 0);
	lv_style_set_img_opa(&style_ui_oven_img_label_bg_main_main_default, 255);
	lv_obj_add_style(ui->ui_Oven_Img_Label_Bg, &style_ui_oven_img_label_bg_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_add_flag(ui->ui_Oven_Img_Label_Bg, LV_OBJ_FLAG_CLICKABLE);
	lv_img_set_src(ui->ui_Oven_Img_Label_Bg,&_title_bg_654x130);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_oven_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_oven_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_oven_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_oven_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_oven_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_oven_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_group_oven_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_group_oven_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_group_oven_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_oven_group_oven_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_group_oven_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_group_oven_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_currtemp_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_currtemp_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_currtemp_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_currtemp_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_currtemp_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_currtemp_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_temp_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_temp_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_temp_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_temp_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_temp_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_temp_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_cen_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_cen_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_cen_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_cen_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_cen_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_cen_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_status_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_status_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_status_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_status_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_status_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_status_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_currstat_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_currstat_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_currstat_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_currstat_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_currstat_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_currstat_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_time_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_time_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_time_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_time_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_time_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_time_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_bar_time_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_bar_time_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_bar_time_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_bar_time_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_bar_time_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_bar_time_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_btn_modeleft_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_btn_modeleft_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_btn_modeleft_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_btn_modeleft_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_btn_modeleft_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_btn_modeleft_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_btn_modeleft_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_ui_oven_btn_modeleft_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_btn_modeleft_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_ui_oven_btn_modeleft_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_btn_modeleft_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_btn_modeleft_main_main_pressed, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_btn_modeleft_main_main_checked, 0);
	lv_style_set_shadow_color(&style_ui_oven_btn_modeleft_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_btn_modeleft_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_ui_oven_btn_modeleft_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_btn_modeleft_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_btn_modeleft_main_main_checked, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_btn_moderigth_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_btn_moderigth_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_btn_moderigth_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_btn_moderigth_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_btn_moderigth_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_btn_moderigth_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_btn_state_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_btn_state_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_btn_state_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_btn_state_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_btn_state_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_btn_state_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_btn_state_main_main_checked, 0);
	lv_style_set_shadow_color(&style_ui_oven_btn_state_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_btn_state_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_ui_oven_btn_state_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_btn_state_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_btn_state_main_main_checked, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_settings_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_settings_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_settings_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_settings_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_settings_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_settings_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_timeleft_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_timeleft_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_timeleft_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_timeleft_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_timeleft_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_timeleft_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_min_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_min_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_min_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_min_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_min_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_min_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_tile_mode_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_tile_mode_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_tile_mode_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_tile_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_tile_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_tile_mode_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode9_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode9_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode9_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode9_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode9_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode9_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode8_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode8_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode8_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode8_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode8_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode8_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode7_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode7_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode7_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode7_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode7_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode7_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode6_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode6_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode6_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode6_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode6_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode6_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode5_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode5_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode5_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode5_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode5_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode5_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode4_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode4_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode4_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode4_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode4_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode4_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode3_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode3_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode3_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode3_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode3_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode3_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode2_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode2_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode2_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode2_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode2_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode2_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_mode1_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_mode1_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_mode1_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_mode1_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_mode1_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_mode1_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_group_tartemp_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_group_tartemp_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_group_tartemp_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_oven_group_tartemp_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_group_tartemp_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_group_tartemp_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_seltemp_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_seltemp_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_seltemp_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_seltemp_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_seltemp_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_seltemp_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_tarcen_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_tarcen_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_tarcen_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_tarcen_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_tarcen_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_tarcen_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_group_timer_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_group_timer_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_group_timer_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_oven_group_timer_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_group_timer_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_group_timer_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_seltimer_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_seltimer_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_seltimer_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_seltimer_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_seltimer_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_seltimer_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_oven_label_timersel_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_label_timersel_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_label_timersel_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_label_timersel_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_label_timersel_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_label_timersel_main_main_default, 0);
	...
	//Write style state: LV_STATE_DEFAULT for style_ui_oven_ui_btn_back3_main_main_default
	static lv_style_t style_ui_oven_ui_btn_back3_main_main_default;
	if (style_ui_oven_ui_btn_back3_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_ui_oven_ui_btn_back3_main_main_default);
	else
		lv_style_init(&style_ui_oven_ui_btn_back3_main_main_default);
	lv_style_set_radius(&style_ui_oven_ui_btn_back3_main_main_default, 65);
	lv_style_set_bg_color(&style_ui_oven_ui_btn_back3_main_main_default, lv_color_make(0x18, 0x18, 0x18));
	lv_style_set_bg_grad_color(&style_ui_oven_ui_btn_back3_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_bg_grad_dir(&style_ui_oven_ui_btn_back3_main_main_default, LV_GRAD_DIR_NONE);
	lv_style_set_bg_opa(&style_ui_oven_ui_btn_back3_main_main_default, 255);
	lv_style_set_shadow_width(&style_ui_oven_ui_btn_back3_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_oven_ui_btn_back3_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_oven_ui_btn_back3_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_oven_ui_btn_back3_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_oven_ui_btn_back3_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_oven_ui_btn_back3_main_main_default, 0);
	lv_style_set_border_color(&style_ui_oven_ui_btn_back3_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_border_width(&style_ui_oven_ui_btn_back3_main_main_default, 0);
	lv_style_set_border_opa(&style_ui_oven_ui_btn_back3_main_main_default, 255);
	lv_style_set_text_color(&style_ui_oven_ui_btn_back3_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_text_font(&style_ui_oven_ui_btn_back3_main_main_default, &lv_font_montserratMedium_16);
	lv_style_set_text_align(&style_ui_oven_ui_btn_back3_main_main_default, LV_TEXT_ALIGN_CENTER);
	lv_obj_add_style(ui->ui_Oven_ui_Btn_Back3, &style_ui_oven_ui_btn_back3_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);
