...
void setup_scr_ui_Aircon(lv_ui *ui){
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_air_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_air_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_air_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_air_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_air_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_air_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_cont_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_cont_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_cont_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_cont_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_cont_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_cont_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_temp_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_temp_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_temp_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_temp_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_temp_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_temp_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_tempup_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_tempup_main_main_default, lv_color_make(0xCD, 0xF6, 0xFF));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_tempup_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_tempup_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_tempup_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_tempup_main_main_default, 2);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_tempup_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_tempup_main_main_pressed, lv_color_make(0x18, 0xC2, 0x20));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_tempup_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_tempup_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_tempup_main_main_pressed, 50);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_tempup_main_main_pressed, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_settemp_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_settemp_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_settemp_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_settemp_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_settemp_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_settemp_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_cen_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_cen_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_cen_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_cen_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_cen_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_cen_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_tempdown_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_tempdown_main_main_default, lv_color_make(0xCD, 0xF6, 0xFF));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_tempdown_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_tempdown_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_tempdown_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_tempdown_main_main_default, 2);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_tempdown_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_tempdown_main_main_pressed, lv_color_make(0x18, 0xC2, 0x20));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_tempdown_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_tempdown_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_tempdown_main_main_pressed, 50);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_tempdown_main_main_pressed, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_roller_mode_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_roller_mode_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_roller_mode_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_roller_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_roller_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_roller_mode_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_swing_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_swing_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_swing_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_swing_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_swing_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_swing_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_swing_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_swing_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_swing_main_main_pressed, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_swing_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_swing_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_swing_main_main_pressed, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_swing_main_main_checked, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_swing_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_swing_main_main_checked, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_swing_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_swing_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_swing_main_main_checked, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_swing_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_swing_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_swing_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_label_swing_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_swing_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_swing_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_timer_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_timer_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_timer_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_timer_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_timer_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_timer_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_mode_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_mode_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_mode_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_mode_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_mode_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_fan_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_fan_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_fan_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_label_fan_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_fan_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_fan_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_slider_fan_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_slider_fan_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_slider_fan_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_slider_fan_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_slider_fan_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_slider_fan_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_low_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_low_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_low_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_low_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_low_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_low_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_medium_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_medium_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_medium_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_medium_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_medium_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_medium_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_high_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_high_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_high_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_high_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_high_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_high_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_comp_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_comp_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_comp_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_label_comp_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_comp_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_comp_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_on_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_on_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_on_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_label_on_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_on_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_on_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_fanst_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_fanst_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_fanst_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_label_fanst_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_fanst_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_fanst_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_fanstate_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_fanstate_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_fanstate_main_main_default, 0);
	lv_style_set_shadow_spread(&style_ui_aircon_label_fanstate_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_fanstate_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_fanstate_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_timerup_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_timerup_main_main_default, lv_color_make(0xCD, 0xF6, 0xFF));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_timerup_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_timerup_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_timerup_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_timerup_main_main_default, 2);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_timerup_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_timerup_main_main_pressed, lv_color_make(0x18, 0xC2, 0x20));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_timerup_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_timerup_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_timerup_main_main_pressed, 50);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_timerup_main_main_pressed, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_timerdown_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_timerdown_main_main_default, lv_color_make(0xCD, 0xF6, 0xFF));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_timerdown_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_timerdown_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_timerdown_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_timerdown_main_main_default, 2);
	...
	lv_style_set_shadow_width(&style_ui_aircon_btn_timerdown_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_ui_aircon_btn_timerdown_main_main_pressed, lv_color_make(0x18, 0xC2, 0x20));
	lv_style_set_shadow_opa(&style_ui_aircon_btn_timerdown_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_btn_timerdown_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_btn_timerdown_main_main_pressed, 50);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_btn_timerdown_main_main_pressed, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_timerhour_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_timerhour_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_timerhour_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_timerhour_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_timerhour_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_timerhour_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_timerpoints_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_timerpoints_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_timerpoints_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_timerpoints_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_timerpoints_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_timerpoints_main_main_default, 0);
	...
	lv_style_set_shadow_width(&style_ui_aircon_label_timermin_main_main_default, 0);
	lv_style_set_shadow_color(&style_ui_aircon_label_timermin_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_ui_aircon_label_timermin_main_main_default, 255);
	lv_style_set_shadow_spread(&style_ui_aircon_label_timermin_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_ui_aircon_label_timermin_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_ui_aircon_label_timermin_main_main_default, 0);
