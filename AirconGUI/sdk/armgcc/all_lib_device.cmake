...
#set.board.evkbmimxrt1170
#  # description: Board_project_template evkbmimxrt1170
#  set(CONFIG_USE_BOARD_Project_Template_evkbmimxrt1170 true)
...
#  # description: Device MIMXRT1176_startup
#  set(CONFIG_USE_device_MIMXRT1176_startup true)

#  # description: Device MIMXRT1176_system
#  set(CONFIG_USE_device_MIMXRT1176_system true)

#  # description: Device MIMXRT1176_cmsis
...
#  set(CONFIG_USE_component_power_manager_MIMXRT1176 true)
...
#  # description: Driver mdio-common
#  set(CONFIG_USE_driver_mdio-common true)

#  # description: Driver mdio-enet-qos
#  set(CONFIG_USE_driver_mdio-enet-qos true)

#  # description: Driver mdio-enet
#  set(CONFIG_USE_driver_mdio-enet true)
...
#set.middleware.canopen
#  # description: CANopen library files unused by projects
#  set(CONFIG_USE_middleware_canopen_unused_files true)

#  # description: CANopen library
#  set(CONFIG_USE_middleware_canopen true)
...
#  set(CONFIG_USE_middleware_embedded_wizard_template_evkbmimxrt1170 true)

#  # description: embedded_wizard template
#  set(CONFIG_USE_middleware_embedded_wizard_template_evkmimxrt1170 true)

#  # description: embedded_wizard library
#  set(CONFIG_USE_middleware_embedded_wizard_evkbmimxrt1170 true)

#  # description: embedded_wizard library
#  set(CONFIG_USE_middleware_embedded_wizard_lib_evkmimxrt1170 true)

#  # description: embedded_wizard library
#  set(CONFIG_USE_middleware_embedded_wizard_lib_evkbmimxrt1170 true)

#  # description: embedded_wizard library
#  set(CONFIG_USE_middleware_embedded_wizard_evkmimxrt1170 true)
...
#  # description: CLI, IoT reference common example component
...
#  # description: OTA, IoT reference common example component
#  set(CONFIG_USE_middleware_iot_reference_ota true)

#  # description: shadow, IoT reference common example component
#  set(CONFIG_USE_middleware_iot_reference_shadow true)

#  # description: shadow tasks, IoT reference common example component
...
#  # description: Multicore Manager for evkmimxrt1170 board
#  set(CONFIG_USE_middleware_multicore_mcmgr_imxrt1170 true)

#  # description: RPMsg-Lite for evkmimxrt1170 baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imxrt1170_bm true)

#  # description: RPMsg-Lite for evkmimxrt1170 FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imxrt1170_freertos true)

#  # description: RPMsg-Lite baremetal for evkmimxrt1170 board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_imxrt1170 true)

#  # description: RPMsg-Lite FreeRTOS for evkmimxrt1170 board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_freertos_config_imxrt1170 true)
...
#set.middleware.vit
#  # description: vit template
#  set(CONFIG_USE_middleware_vit_template true)
...
#  # description: voice_seeker template
#  set(CONFIG_USE_middleware_voice_seeker_template true)
...
#  set(CONFIG_USE_middleware_edgefast_bluetooth_btble_ethermind_cm4f true)

#  # description: edgefast_bluetooth bt_ble Host stack(including BLE only)
#  set(CONFIG_USE_middleware_edgefast_bluetooth_ble_ethermind_cm4f true)
...
#  set(CONFIG_USE_middleware_edgefast_bluetooth_btble_ethermind_lib_cm4f true)

#  # description: BR libraries for bt_ble Host stack
#  set(CONFIG_USE_middleware_edgefast_bluetooth_br_ethermind_lib_cm4f true)
...
#  # description: imxrt1170 files
#  set(CONFIG_USE_middleware_mcu-boot_imxrt1170_files true)
...
#  # description: MCUBOOT MIMXRT1176 startup sources
#  set(CONFIG_USE_middleware_mcu-boot_MIMXRT1176_startup true)
...
#  set(CONFIG_USE_middleware_eiq_worker_video true)
...
#  set(CONFIG_USE_middleware_se_hostlib_common_A71CH true)

#  # description: se_hostlib A71CHhostCrypto
#  set(CONFIG_USE_middleware_se_hostlib_A71CHhostCrypto true)

#  # description: se_hostlib commonA71CHsmCom
#  set(CONFIG_USE_middleware_se_hostlib_commonA71CHsmCom true)
...
#  # description: se_hostlib A71CHApisrc
#  set(CONFIG_USE_middleware_se_hostlib_A71CHApisrc true)
...
#  # description: se_hostlib a71ch
#  set(CONFIG_USE_middleware_se_hostlib_a71ch true)

#  # description: se_hostlib tstutils
#  set(CONFIG_USE_middleware_se_hostlib_tstutils true)

#  # description: se_hostlib mbedtls_altA71CH
#  set(CONFIG_USE_middleware_se_hostlib_mbedtls_altA71CH true)

#  # description: se_hostlib mbedtls_sss
#  set(CONFIG_USE_middleware_se_hostlib_mbedtls_sss true)

#  # description: se_hostlib serial_manager_usb_cdc
#  set(CONFIG_USE_middleware_se_hostlib_serial_manager_usb_cdc true)

#  # description: se_hostlib nxp_iot_agent_lib
#  set(CONFIG_USE_middleware_se_hostlib_nxp_iot_agent_lib true)
...
#  set(CONFIG_USE_middleware_crank_template_evkbmimxrt1170 true)

#  # description: Crank Storyboard GUI
#  set(CONFIG_USE_middleware_crank_evkbmimxrt1170 true)

#  # description: Crank Storyboard GUI freetype font
#  set(CONFIG_USE_middleware_crank_freetype true)

#  # description: Crank Storyboard GUI sbfont
#  set(CONFIG_USE_middleware_crank_sbfont true)

#  # description: Crank Storyboard GUI vglite
#  set(CONFIG_USE_middleware_crank_vglite true)

#  # description: crank template
#  set(CONFIG_USE_middleware_crank_template_evkmimxrt1170 true)
...
#set.middleware.rlottie
#  # description: rlottie Library
#  set(CONFIG_USE_middleware_rlottie true)
...
#  # description: ACIM control middleware, floating point implementation.
#  set(CONFIG_USE_middleware_mc_acim_float true)
...
#  # description: Motor Control Advanced Algorithm for CM7F core
#  set(CONFIG_USE_middleware_motor_control_mcaa_cm7f true)

#  # description: Motor Control Advanced Algorithm for CM4F core
#  set(CONFIG_USE_middleware_motor_control_mcaa_cm4f true)

#  # description: Real Time Control Embedded Software Library for CM4F core
#  set(CONFIG_USE_middleware_rtcesl_cm4f true)
...
${CMAKE_CURRENT_LIST_DIR}/component/serial_manager
${CMAKE_CURRENT_LIST_DIR}/component/uart
${CMAKE_CURRENT_LIST_DIR}/device
${CMAKE_CURRENT_LIST_DIR}/drivers
${CMAKE_CURRENT_LIST_DIR}/freertos/freertos-kernel
${CMAKE_CURRENT_LIST_DIR}/lvgl
${CMAKE_CURRENT_LIST_DIR}/startup
${CMAKE_CURRENT_LIST_DIR}/touchpanel
...
include_if_use(BOARD_Project_Template_evkbmimxrt1170)
include_if_use(BOARD_Project_Template_evkbmimxrt1170_om13790host)
include_if_use(BOARD_Project_Template_evkmimxrt1170)
include_if_use(BOARD_Project_Template_evkmimxrt1170_agm01)
include_if_use(BOARD_Project_Template_evkmimxrt1170_om13790host)
...
include_if_use(DEVICES_Project_Template_MIMXRT1176.MIMXRT1176)
include_if_use(RTE_Device.MIMXRT1176)
include_if_use(component_audio_sai_edma_adapter.MIMXRT1176)
include_if_use(component_button.MIMXRT1176)
include_if_use(component_codec_adapters.MIMXRT1176)
include_if_use(component_codec_i2c.MIMXRT1176)
include_if_use(component_common_task)
include_if_use(component_cs42448_adapter.MIMXRT1176)
include_if_use(component_cs42888_adapter.MIMXRT1176)
include_if_use(component_da7212_adapter.MIMXRT1176)
include_if_use(component_ecspi_adapter.MIMXRT1176)
include_if_use(component_eeprom_AT25Fxxxx.MIMXRT1176)
include_if_use(component_eeprom_AT45DBxxxx.MIMXRT1176)
include_if_use(component_eeprom_InternalFlash.MIMXRT1176)
include_if_use(component_exception_handling_cm7.MIMXRT1176)
...
include_if_use(component_log.MIMXRT1176)
include_if_use(component_log_backend_debugconsole.MIMXRT1176)
include_if_use(component_log_backend_debugconsole_lite.MIMXRT1176)
include_if_use(component_log_backend_ringbuffer.MIMXRT1176)
include_if_use(component_lpcrtc.MIMXRT1176)
include_if_use(component_lpi2c_adapter.MIMXRT1176)
include_if_use(component_lpspi_adapter.MIMXRT1176)
include_if_use(component_lpuart_adapter.MIMXRT1176)
include_if_use(component_lpuart_dma_adapter.MIMXRT1176)
include_if_use(component_mem_manager.MIMXRT1176)
include_if_use(component_mem_manager_light.MIMXRT1176)
include_if_use(component_messaging.MIMXRT1176)
include_if_use(component_mflash_common.MIMXRT1176)
include_if_use(component_mflash_dummy.MIMXRT1176)
...
include_if_use(component_minispi_adapter.MIMXRT1176)
...
include_if_use(component_serial_manager.MIMXRT1176)
include_if_use(component_serial_manager_spi.MIMXRT1176)
include_if_use(component_serial_manager_swo.MIMXRT1176)
include_if_use(component_serial_manager_uart.MIMXRT1176)
include_if_use(component_serial_manager_usb_cdc.MIMXRT1176)
include_if_use(component_serial_manager_virtual.MIMXRT1176)
include_if_use(component_sgtl_adapter.MIMXRT1176)
include_if_use(component_silicon_id.MIMXRT1176)
include_if_use(component_silicon_id_rt1170.MIMXRT1176)
...
include_if_use(component_vspi_adapter.MIMXRT1176)
...
include_if_use(device_MIMXRT1176_CMSIS.MIMXRT1176)
include_if_use(device_MIMXRT1176_startup.MIMXRT1176)
include_if_use(device_MIMXRT1176_system.MIMXRT1176)
include_if_use(driver_acmp.MIMXRT1176)
include_if_use(driver_adc_etc.MIMXRT1176)
include_if_use(driver_anatop_ai.MIMXRT1176)
include_if_use(driver_aoi.MIMXRT1176)
include_if_use(driver_asrc.MIMXRT1176)
include_if_use(driver_asrc_edma.MIMXRT1176)
include_if_use(driver_caam.MIMXRT1176)
include_if_use(driver_cache_armv7_m7.MIMXRT1176)
include_if_use(driver_cache_lmem.MIMXRT1176)
include_if_use(driver_camera-common.MIMXRT1176)
include_if_use(driver_camera-device-common.MIMXRT1176)
include_if_use(driver_camera-device-max9286.MIMXRT1176)
include_if_use(driver_camera-device-mt9m114.MIMXRT1176)
include_if_use(driver_camera-device-ov5640.MIMXRT1176)
include_if_use(driver_camera-device-ov7670.MIMXRT1176)
include_if_use(driver_camera-device-ov7725.MIMXRT1176)
include_if_use(driver_camera-device-sccb.MIMXRT1176)
include_if_use(driver_camera-receiver-common.MIMXRT1176)
include_if_use(driver_camera-receiver-csi.MIMXRT1176)
include_if_use(driver_camera-receiver-flexio.MIMXRT1176)
include_if_use(driver_cdog.MIMXRT1176)
include_if_use(driver_clock.MIMXRT1176)
include_if_use(driver_cmsis_enet.MIMXRT1176)
include_if_use(driver_cmsis_lpi2c.MIMXRT1176)
include_if_use(driver_cmsis_lpspi.MIMXRT1176)
include_if_use(driver_cmsis_lpuart.MIMXRT1176)
include_if_use(driver_codec.MIMXRT1176)
include_if_use(driver_common.MIMXRT1176)
include_if_use(driver_cs42448.MIMXRT1176)
include_if_use(driver_cs42888.MIMXRT1176)
include_if_use(driver_csi.MIMXRT1176)
include_if_use(driver_dac12.MIMXRT1176)
include_if_use(driver_dbi.MIMXRT1176)
include_if_use(driver_dbi_flexio_edma.MIMXRT1176)
include_if_use(driver_dc-fb-common.MIMXRT1176)
include_if_use(driver_dc-fb-dsi-cmd.MIMXRT1176)
include_if_use(driver_dc-fb-elcdif.MIMXRT1176)
include_if_use(driver_dc-fb-lcdifv2.MIMXRT1176)
include_if_use(driver_dc-fb-ssd1963.MIMXRT1176)
include_if_use(driver_dcdc_soc.MIMXRT1176)
include_if_use(driver_dcic.MIMXRT1176)
include_if_use(driver_dialog7212.MIMXRT1176)
include_if_use(driver_display-adv7535.MIMXRT1176)
include_if_use(driver_display-common.MIMXRT1176)
include_if_use(driver_display-hx8394.MIMXRT1176)
include_if_use(driver_display-it6161.MIMXRT1176)
include_if_use(driver_display-it6263.MIMXRT1176)
include_if_use(driver_display-mipi-dsi-cmd.MIMXRT1176)
include_if_use(driver_display-rm67162.MIMXRT1176)
include_if_use(driver_display-rm67191.MIMXRT1176)
include_if_use(driver_display-rm68191.MIMXRT1176)
include_if_use(driver_display-rm68200.MIMXRT1176)
include_if_use(driver_dmamux.MIMXRT1176)
include_if_use(driver_edma.MIMXRT1176)
include_if_use(driver_elcdif.MIMXRT1176)
include_if_use(driver_enc.MIMXRT1176)
include_if_use(driver_enet.MIMXRT1176)
include_if_use(driver_enet_qos.MIMXRT1176)
include_if_use(driver_ewm.MIMXRT1176)
include_if_use(driver_fbdev.MIMXRT1176)
include_if_use(driver_flexcan.MIMXRT1176)
include_if_use(driver_flexcan_edma.MIMXRT1176)
include_if_use(driver_flexio.MIMXRT1176)
include_if_use(driver_flexio_camera.MIMXRT1176)
include_if_use(driver_flexio_camera_edma.MIMXRT1176)
include_if_use(driver_flexio_i2c_master.MIMXRT1176)
include_if_use(driver_flexio_i2s.MIMXRT1176)
include_if_use(driver_flexio_i2s_edma.MIMXRT1176)
include_if_use(driver_flexio_mculcd.MIMXRT1176)
include_if_use(driver_flexio_mculcd_edma.MIMXRT1176)
include_if_use(driver_flexio_spi.MIMXRT1176)
include_if_use(driver_flexio_spi_edma.MIMXRT1176)
include_if_use(driver_flexio_uart.MIMXRT1176)
include_if_use(driver_flexio_uart_edma.MIMXRT1176)
include_if_use(driver_flexram.MIMXRT1176)
include_if_use(driver_flexspi.MIMXRT1176)
include_if_use(driver_flexspi_edma.MIMXRT1176)
include_if_use(driver_ft5406.MIMXRT1176)
include_if_use(driver_ft5406_rt.MIMXRT1176)
include_if_use(driver_ft6x06.MIMXRT1176)
include_if_use(driver_fxls8974cf.MIMXRT1176)
include_if_use(driver_fxos8700cq.MIMXRT1176)
include_if_use(driver_gpc_3.MIMXRT1176)
include_if_use(driver_gpt.MIMXRT1176)
include_if_use(driver_gt911.MIMXRT1176)
include_if_use(driver_iee.MIMXRT1176)
include_if_use(driver_iee_apc.MIMXRT1176)
include_if_use(driver_igpio.MIMXRT1176)
include_if_use(driver_ili9341.MIMXRT1176)
include_if_use(driver_iomuxc.MIMXRT1176)
include_if_use(driver_key_manager.MIMXRT1176)
include_if_use(driver_kpp.MIMXRT1176)
include_if_use(driver_lcdifv2.MIMXRT1176)
include_if_use(driver_lpadc.MIMXRT1176)
include_if_use(driver_lpi2c.MIMXRT1176)
include_if_use(driver_lpi2c_edma.MIMXRT1176)
include_if_use(driver_lpi2c_freertos.MIMXRT1176)
include_if_use(driver_lpspi.MIMXRT1176)
include_if_use(driver_lpspi_edma.MIMXRT1176)
include_if_use(driver_lpspi_freertos.MIMXRT1176)
include_if_use(driver_lpuart.MIMXRT1176)
include_if_use(driver_lpuart_edma.MIMXRT1176)
include_if_use(driver_lpuart_freertos.MIMXRT1176)
include_if_use(driver_mdio-common.MIMXRT1176)
include_if_use(driver_mdio-enet-qos.MIMXRT1176)
include_if_use(driver_mdio-enet.MIMXRT1176)
include_if_use(driver_mecc.MIMXRT1176)
include_if_use(driver_memory.MIMXRT1176)
include_if_use(driver_mipi_csi2rx.MIMXRT1176)
include_if_use(driver_mipi_dsi_split.MIMXRT1176)
include_if_use(driver_mma8451q.MIMXRT1176)
include_if_use(driver_mu.MIMXRT1176)
include_if_use(driver_mx25r_flash.MIMXRT1176)
include_if_use(driver_nand_flash-common.MIMXRT1176)
include_if_use(driver_nand_flash-controller-flexspi.MIMXRT1176)
include_if_use(driver_nand_flash-controller-semc.MIMXRT1176)
include_if_use(driver_nic301.MIMXRT1176)
include_if_use(driver_nor_flash-common.MIMXRT1176)
include_if_use(driver_nor_flash-controller-flexspi.MIMXRT1176)
include_if_use(driver_nor_flash-controller-lpspi.MIMXRT1176)
include_if_use(driver_ocotp.MIMXRT1176)
include_if_use(driver_pdm.MIMXRT1176)
include_if_use(driver_pdm_edma.MIMXRT1176)
include_if_use(driver_pf1550.MIMXRT1176)
include_if_use(driver_pf3000.MIMXRT1176)
include_if_use(driver_pf5020.MIMXRT1176)
include_if_use(driver_pgmc.MIMXRT1176)
include_if_use(driver_phy-common.MIMXRT1176)
include_if_use(driver_phy-device-ar8031.MIMXRT1176)
include_if_use(driver_phy-device-dp83848.MIMXRT1176)
include_if_use(driver_phy-device-ksz8041.MIMXRT1176)
include_if_use(driver_phy-device-ksz8081.MIMXRT1176)
include_if_use(driver_phy-device-lan8720a.MIMXRT1176)
include_if_use(driver_phy-device-lan8741.MIMXRT1176)
include_if_use(driver_phy-device-rtl8201.MIMXRT1176)
include_if_use(driver_phy-device-rtl8211f.MIMXRT1176)
include_if_use(driver_phy-device-vsc8541.MIMXRT1176)
include_if_use(driver_pit.MIMXRT1176)
include_if_use(driver_pmu_1.MIMXRT1176)
include_if_use(driver_puf.MIMXRT1176)
include_if_use(driver_pwm.MIMXRT1176)
include_if_use(driver_pxp.MIMXRT1176)
include_if_use(driver_qtmr_1.MIMXRT1176)
include_if_use(driver_rdc.MIMXRT1176)
include_if_use(driver_rdc_sema42.MIMXRT1176)
include_if_use(driver_romapi.MIMXRT1176)
include_if_use(driver_rtwdog.MIMXRT1176)
include_if_use(driver_sai.MIMXRT1176)
include_if_use(driver_sai_edma.MIMXRT1176)
include_if_use(driver_sema4.MIMXRT1176)
include_if_use(driver_semc.MIMXRT1176)
include_if_use(driver_sgtl5000.MIMXRT1176)
include_if_use(driver_smartcard_emvsim.MIMXRT1176)
include_if_use(driver_smartcard_phy_emvsim.MIMXRT1176)
include_if_use(driver_snvs_hp.MIMXRT1176)
...
include_if_use(driver_ssarc.MIMXRT1176)
include_if_use(driver_ssd1963.MIMXRT1176)
include_if_use(driver_tempsensor.MIMXRT1176)
include_if_use(driver_usdhc.MIMXRT1176)
include_if_use(driver_video-common.MIMXRT1176)
include_if_use(driver_video-i2c.MIMXRT1176)
include_if_use(driver_wdog01.MIMXRT1176)
include_if_use(driver_wm8960.MIMXRT1176)
include_if_use(driver_wm8962.MIMXRT1176)
include_if_use(driver_xbara.MIMXRT1176)
include_if_use(driver_xbarb.MIMXRT1176)
include_if_use(driver_xecc.MIMXRT1176)
include_if_use(driver_xip_board_evkbmimxrt1170)
include_if_use(driver_xip_board_evkmimxrt1170)
include_if_use(driver_xip_device.MIMXRT1176)
include_if_use(driver_xmcd_evkbmimxrt1170)
...
include_if_use(middleware_baremetal.MIMXRT1176)
include_if_use(middleware_canopen)
include_if_use(middleware_canopen_unused_files)
include_if_use(middleware_crank_evkbmimxrt1170)
include_if_use(middleware_crank_evkmimxrt1170)
include_if_use(middleware_crank_freetype)
include_if_use(middleware_crank_sbfont)
include_if_use(middleware_crank_template_evkbmimxrt1170)
include_if_use(middleware_crank_template_evkmimxrt1170)
include_if_use(middleware_crank_vglite)
...
include_if_use(middleware_eiq_deepviewrt_deps_stb)
include_if_use(middleware_eiq_deepviewrt_modelrunner_server)
...
include_if_use(middleware_eiq_worker_video)
...
include_if_use(middleware_embedded_wizard_lib_evkmimxrt1170)
include_if_use(middleware_embedded_wizard_template_evkbmimxrt1170)
include_if_use(middleware_embedded_wizard_template_evkmimxrt1170)
...
include_if_use(middleware_mcu-boot_MIMXRT1176_sources)
include_if_use(middleware_mcu-boot_MIMXRT1176_startup)
...
include_if_use(middleware_mcu-boot_imxrt1170_files)
...
include_if_use(middleware_mmcau_cm4_cm7)
...
include_if_use(middleware_multicore_rpmsg_lite_freertos_config_imxrt1170)
include_if_use(middleware_multicore_rpmsg_lite_imxrt1170_bm)
include_if_use(middleware_multicore_rpmsg_lite_imxrt1170_freertos)
...
include_if_use(middleware_sdmmc_host_usdhc_azurertos)
...
include_if_use(middleware_sdmmc_osa_azurertos)
...
include_if_use(middleware_se_hostlib_A71CHApisrc)
include_if_use(middleware_se_hostlib_A71CHhostCrypto)
include_if_use(middleware_se_hostlib_a71ch)
include_if_use(middleware_se_hostlib_commonA71CHsmCom)
...
include_if_use(middleware_se_hostlib_common_A71CH)
include_if_use(middleware_se_hostlib_mbedtls_altA71CH)
...
include_if_use(middleware_rlottie)
include_if_use(utilities_misc_utilities.MIMXRT1176)
include_if_use(utility_assert.MIMXRT1176)
include_if_use(utility_assert_lite.MIMXRT1176)
include_if_use(utility_debug_console.MIMXRT1176)
include_if_use(utility_debug_console_lite.MIMXRT1176)
include_if_use(utility_incbin.MIMXRT1176)
