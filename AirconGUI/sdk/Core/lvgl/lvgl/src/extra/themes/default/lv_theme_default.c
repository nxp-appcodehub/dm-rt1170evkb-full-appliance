...
#if LV_USE_RADIOBTN
    lv_style_t rb_marker, rb_marker_checked;
#endif
...
static void style_init(void)
{
    ...
    lv_style_set_bg_img_src(&styles->rb_marker_checked, NULL);
    lv_style_set_text_color(&styles->rb_marker_checked, lv_color_white());
    lv_style_set_text_font(&styles->rb_marker_checked, theme.font_small);
#endif
