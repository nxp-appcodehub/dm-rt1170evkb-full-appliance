                             ...
                             uint16_t NumberOfChannel, uint16_t AFE_VoiceSeekerEnable)
{
    ...
    */
    ...
    AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm = (rdsp_xyz_t*)OSA_MemoryAllocate(sizeof(rdsp_xyz_t) * AFE_VoiceSeekerConfig->vsl_config.num_mics);
    ...
    AFE_VoiceSeekerConfig->heap_memory = OSA_MemoryAllocate(heap_req_bytes);
    ...
    AFE_VoiceSeekerConfig->mic_in = (float**)OSA_MemoryAllocate(sizeof(float*) * AFE_VoiceSeekerConfig->vsl_config.num_mics);
...
int16_t AFE_VoiceSeeker_Delete(AFE_VoiceSeeker_st* AFE_VoiceSeekerConfig)
{
    ...
    if (AFE_VoiceSeekerConfig->mic_in != NULL)
        OSA_MemoryFree(AFE_VoiceSeekerConfig->mic_in);
    ...
    OSA_MemoryFree(AFE_VoiceSeekerConfig->vsl_config.mic_xyz_mm);

    // Free VoiceSeeker Light App memory
    OSA_MemoryFree(AFE_VoiceSeekerConfig->heap_memory);
